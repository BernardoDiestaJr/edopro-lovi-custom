...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Special Summon 1 Level 5 or lower "Piscera" monster from your hand or GY in face-down Defense Position
...
function s.spfilter(c,e,tp)
	return c:IsLevelBelow(5) and c:IsSetCard(0x1fe) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id)
end
