...
function s.initial_effect(c)
	...
	Xyz.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_FAIRY),5,4,s.ovfilter,aux.Stringid(id,2),4,s.xyzop)
	--Change ATK
...
function s.thfilter(c)
	return c:IsSetCard(0x45e) and c:IsMonster() and c:IsAbleToHand()
end
