...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--If this face-up card in the Field Zone is sent to the GY or banishment: You can Special Summon 1 Link-3 or lower "Fantasia" monster from your Extra Deck (This is treated as a link summon.) 
	...
	e5:SetTarget(function(_,c) return c:IsSetCard(0x1f9) and c:IsType(TYPE_LINK) end)
	e5:SetValue(1600)
	c:RegisterEffect(e5)
end
