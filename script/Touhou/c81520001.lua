...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Send up to 2 WIND Synchro Monsters from your Extra Deck to the GY, except a Level 6 or lower monster; Special Summon 1 non-Tuner "Windrous" monster from your GY or banishment
