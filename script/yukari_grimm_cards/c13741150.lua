--Vicious Theatre Alice of Wonderland
local s,id=GetID()
function s.initial_effect(c)
	...
	e2:SetValue(s.xyzlv)
	c:RegisterEffect(e2)
	--Take 1 Level 3 "Vicious Theatre" monster from your Deck except itself and either add it to your hand or Special Summon it
...
function s.thspfilter(c,e,tp,sp_chk)
	return c:IsSetCard(0x41e) and c:IsLevel(3) and c:IsMonster() and not c:IsCode(id) and (c:IsAbleToHand()
